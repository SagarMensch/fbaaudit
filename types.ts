...
// PaymentBatch moved to Line 1010 to avoid duplicate identifier
// Keeping this comment for code structure preservation
...
export type VehicleType = 'Tata Ace' | '407' | '19ft' | '32ft SXL' | '32ft MXL' | '20ft SXL' | '40ft Trailer' | '10-Tyre' | 'Taurus' | 'Air' | 'Van' | 'Bike';
...
export interface Contract {
  ...
  status: 'DRAFT' | 'ACTIVE' | 'EXPIRED' | 'PENDING_APPROVAL' | 'EXPIRING';
...
export interface PaymentBatch {
  ...
  // Merged from previous definition
  runDate?: string;
  entity?: string;

...
const SEED_CONTRACTS: Contract[] = [
    // 1. TCI Express - Express Service (COMPREHENSIVE CONTRACT)
    {
        ...
        status: 'ACTIVE',
        freightMatrix: [
            { id: 'fr-001', origin: 'Delhi', destination: 'Mumbai', vehicleType: '32ft MXL', capacityTon: 15, rateBasis: 'Per Kg', baseRate: 12.50, transitTimeHrs: 36 },
            { id: 'fr-002', origin: 'Mumbai', destination: 'Bangalore', vehicleType: '32ft MXL', capacityTon: 15, rateBasis: 'Per Kg', baseRate: 14.00, transitTimeHrs: 24 },
            { id: 'fr-003', origin: 'Delhi', destination: 'Bangalore', vehicleType: '32ft MXL', capacityTon: 15, rateBasis: 'Per Kg', baseRate: 13.50, transitTimeHrs: 36 },
            { id: 'fr-004', origin: 'Delhi', destination: 'Kolkata', vehicleType: '32ft MXL', capacityTon: 15, rateBasis: 'Per Kg', baseRate: 14.50, transitTimeHrs: 48 }
        ],
    ...
    // 2. Blue Dart - Air Express
    {
        ...
        status: 'ACTIVE',
        freightMatrix: [
            { id: 'fr-005', origin: 'Mumbai', destination: 'Delhi', vehicleType: 'Air', capacityTon: 2, rateBasis: 'Per Kg', baseRate: 18.00, transitTimeHrs: 12 },
            { id: 'fr-006', origin: 'Bangalore', destination: 'Chennai', vehicleType: 'Air', capacityTon: 2, rateBasis: 'Per Kg', baseRate: 15.00, transitTimeHrs: 8 },
            { id: 'fr-007', origin: 'Delhi', destination: 'Bangalore', vehicleType: 'Air', capacityTon: 2, rateBasis: 'Per Kg', baseRate: 19.00, transitTimeHrs: 10 }
        ],
    ...
    // 3. Delhivery - Surface Logistics
    {
        ...
        status: 'ACTIVE',
        freightMatrix: [
            { id: 'fr-008', origin: 'Delhi', destination: 'Mumbai', vehicleType: '19ft', capacityTon: 7, rateBasis: 'Per Kg', baseRate: 8.50, minCharge: 1000, transitTimeHrs: 72 },
            { id: 'fr-009', origin: 'Mumbai', destination: 'Bangalore', vehicleType: '19ft', capacityTon: 7, rateBasis: 'Per Kg', baseRate: 9.00, minCharge: 1000, transitTimeHrs: 48 },
            { id: 'fr-010', origin: 'Delhi', destination: 'Bangalore', vehicleType: '19ft', capacityTon: 7, rateBasis: 'Per Kg', baseRate: 8.50, minCharge: 1000, transitTimeHrs: 84 }
        ],
    ...
    // 4. VRL Logistics - Surface Transport
    {
        ...
        status: 'ACTIVE',
        freightMatrix: [
            { id: 'fr-011', origin: 'Chennai', destination: 'Kolkata', vehicleType: '19ft', capacityTon: 7, rateBasis: 'Per Kg', baseRate: 10.00, minCharge: 1500, transitTimeHrs: 96 },
            { id: 'fr-012', origin: 'Pune', destination: 'Ahmedabad', vehicleType: '19ft', capacityTon: 7, rateBasis: 'Per Kg', baseRate: 7.50, minCharge: 1000, transitTimeHrs: 48 }
        ],
    ...
    // 5. Gati - Multi-modal
    {
        ...
        status: 'ACTIVE',
        freightMatrix: [
            { id: 'fr-013', origin: 'Mumbai', destination: 'Chennai', vehicleType: '19ft', capacityTon: 7, rateBasis: 'Per Kg', baseRate: 8.00, minCharge: 1200, transitTimeHrs: 60 },
            { id: 'fr-014', origin: 'Hyderabad', destination: 'Mumbai', vehicleType: '19ft', capacityTon: 7, rateBasis: 'Per Kg', baseRate: 12.00, minCharge: 1500, transitTimeHrs: 48 }
        ],
    ...
    // 6. Safexpress - Express Cargo
    {
        ...
        status: 'ACTIVE',
        freightMatrix: [
            { id: 'fr-015', origin: 'Pune', destination: 'Ahmedabad', vehicleType: '19ft', capacityTon: 7, rateBasis: 'Per Kg', baseRate: 11.00, transitTimeHrs: 36 },
            { id: 'fr-016', origin: 'Jaipur', destination: 'Lucknow', vehicleType: '19ft', capacityTon: 7, rateBasis: 'Per Kg', baseRate: 11.50, transitTimeHrs: 24 }
        ],
    ...
    // 7. Rivigo - FTL Tech-enabled
    {
        ...
        status: 'ACTIVE',
        freightMatrix: [
            { id: 'fr-017', origin: 'Delhi', destination: 'Mumbai', vehicleType: '32ft MXL', capacityTon: 15, rateBasis: 'Per Trip', baseRate: 45000, transitTimeHrs: 48 },
            { id: 'fr-018', origin: 'Mumbai', destination: 'Bangalore', vehicleType: '32ft MXL', capacityTon: 15, rateBasis: 'Per Trip', baseRate: 38000, transitTimeHrs: 36 }
        ],
    ...
    // 8. DTDC - Courier & Cargo
    {
        ...
        status: 'ACTIVE',
        freightMatrix: [
            { id: 'fr-019', origin: 'Bangalore', destination: 'Chennai', vehicleType: '10-Tyre', capacityTon: 9, rateBasis: 'Per Kg', baseRate: 10.00, transitTimeHrs: 18 }
        ],
    ...
    // 9. Professional Couriers - Document & Parcel
    {
        ...
        status: 'EXPIRING',
        freightMatrix: [
            { id: 'fr-020', origin: 'Mumbai', destination: 'Pune', vehicleType: 'Van', capacityTon: 1, rateBasis: 'Per Kg', baseRate: 6.00, minCharge: 300, transitTimeHrs: 6 }
        ],
    ...
    // 10. Ecom Express - E-commerce Focused
    {
        ...
        status: 'ACTIVE',
        freightMatrix: [
            { id: 'fr-021', origin: 'Delhi', destination: 'Mumbai', vehicleType: '19ft', capacityTon: 7, rateBasis: 'Per Kg', baseRate: 11.00, transitTimeHrs: 48 }
        ],
    ...
    // 11. XpressBees - Last Mile
    {
        ...
        status: 'ACTIVE',
        freightMatrix: [
            { id: 'fr-022', origin: 'Pune', destination: 'Mumbai', vehicleType: 'Van', capacityTon: 1, rateBasis: 'Per Kg', baseRate: 5.50, minCharge: 250, transitTimeHrs: 6 }
        ],
    ...
    // 12. Shadowfax - Hyperlocal
    {
        ...
        status: 'ACTIVE',
        freightMatrix: [
            { id: 'fr-023', origin: 'Bangalore', destination: 'Bangalore', vehicleType: 'Bike', capacityTon: 0.05, rateBasis: 'Per Kg', baseRate: 3.00, minCharge: 50, transitTimeHrs: 2 }
        ],
    ...
    // 13. Mahindra Logistics - 3PL
    {
        ...
        status: 'ACTIVE',
        freightMatrix: [
            { id: 'fr-024', origin: 'Mumbai', destination: 'Delhi', vehicleType: '32ft SXL', capacityTon: 20, rateBasis: 'Per Trip', baseRate: 48000, transitTimeHrs: 48 }
        ],
    ...
    // 14. Allcargo - Integrated Logistics
    {
        ...
        status: 'ACTIVE',
        freightMatrix: [
            { id: 'fr-025', origin: 'Chennai', destination: 'Mumbai', vehicleType: '32ft MXL', capacityTon: 15, rateBasis: 'Per Trip', baseRate: 42000, transitTimeHrs: 60 }
        ],

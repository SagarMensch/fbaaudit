...
import { Contract, VehicleType, RateBasis } from '../../types';
import { ContractDetail } from '../transactions/ContractDetail';
...
export const ContractManager: React.FC = () => {
    ...
    const handleAddMatrixRow = () => {
        ...
        const newRow = {
            ...
            baseRate: matrixRow.rate,
            transitTimeHrs: matrixRow.transitTime * 24,
            capacityTon: matrixRow.vehicle === '32ft MXL' ? 15 : (matrixRow.vehicle === '10-Tyre' ? 20 : 9), // Estimate
            rateBasis: 'Per Trip' as RateBasis
        };
        setNewContract(prev => ({
            ...prev,

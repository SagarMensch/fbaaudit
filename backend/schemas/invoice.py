...
class InvoiceSchema(BaseModel):
    ...
    attached_docs: List[str] = Field(default_factory=list, description="List of attached document types (e.g. INVOICE, POD)")
    missing_docs: List[str] = Field(default_factory=list, description="List of missing mandatory documents")

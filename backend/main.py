...
async def lifespan(app: FastAPI):
    ...
    # NO MOCK DATA - RAG will query PostgreSQL database directly
    logger.info("📊 RAG Engine ready to query PostgreSQL database...")
...
# Include SAP Core Router (v2 Architecture)
from routers.sap_api import router as sap_router
app.include_router(sap_router)

# Include Advanced Ingestion Router (Docling + AI Pipeline)
from routers.ingestion_api import router as ingestion_router

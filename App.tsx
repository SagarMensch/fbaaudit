...
import { Dashboard } from './pages/worklists/Dashboard';
import { InvoiceWorkbench } from './pages/worklists/InvoiceWorkbench';
import { InvoiceDetail } from './pages/transactions/InvoiceDetail';
import { RateCards } from './pages/master-data/RateCards';
import { PartnerNetwork } from './pages/master-data/PartnerNetwork';
import { SettlementFinance } from './pages/worklists/SettlementFinance';
import { IntelligenceHub } from './pages/analytics/IntelligenceHub';
import { IntegrationHub } from './pages/master-data/IntegrationHub';
import { InvoiceIngestion } from './pages/transactions/InvoiceIngestion';
import { LandingPage } from './pages/LandingPage';
import { VendorPortal } from './pages/VendorPortal'; // Kept in root/pages for now or move to specific
import { VendorLogin } from './pages/transactions/VendorLogin';
import { UserProfile } from './pages/master-data/UserProfile';
import { RBACSettings } from './pages/master-data/RBACSettings';
import { CostToServe } from './pages/analytics/CostToServe';
import { CarrierPerformance } from './pages/analytics/CarrierPerformance';
import { AnomalyDetection } from './pages/analytics/AnomalyDetection';
import { ContractManager } from './pages/master-data/ContractManager';
import { SpotMarket } from './pages/transactions/SpotMarket';
import { GuestBid } from './pages/transactions/GuestBid';
import { VendorOnboarding } from './pages/master-data/VendorOnboarding';
import { DocumentAnalysis } from './pages/analytics/DocumentAnalysis';
import { VendorScorecard } from './pages/analytics/VendorScorecard';
import { FinanceDashboard } from './pages/worklists/FinanceDashboard';
import { ExecutiveReport } from './pages/analytics/ExecutiveReport';
import { EmissionsDashboard } from './pages/analytics/EmissionsDashboard';
import { TicketInbox } from './pages/worklists/TicketInbox';
import { CapacityForecast } from './pages/analytics/CapacityForecast';
import { ShockRateBenchmark } from './pages/analytics/ShockRateBenchmark';
import { ApproverQueue } from './pages/worklists/ApproverQueue';

import { SupplierDirectory } from './pages/master-data/SupplierDirectory';
import { SupplierLogin } from './pages/transactions/SupplierLogin';
import { SupplierPortalView } from './pages/transactions/SupplierPortalView';
import { DocumentLibrary } from './pages/master-data/DocumentLibrary';
import { InvoiceReview } from './pages/worklists/InvoiceReview';
import { EnhancedInvoiceReview } from './pages/worklists/EnhancedInvoiceReview';
import { MasterDataManagement } from './pages/master-data/MasterDataManagement';
import { MasterDataHub } from './pages/master-data/MasterDataHub';
import { ComprehensiveReports } from './pages/analytics/ComprehensiveReports';
          ...
          <header className="h-14 bg-white border-b border-slate-300 flex items-center justify-between px-6 shadow-sm z-50 flex-shrink-0 relative">
            <div className="flex items-center">
              <h1 className="text-sm font-bold text-slate-700 tracking-tight flex items-center mr-6 uppercase">
                {userRole === 'HITACHI' ? <span className="font-cursive text-3xl text-black lowercase first-letter:text-[#E60012] first-letter:uppercase mr-3" style={{ transform: 'translateY(4px)' }}>Confidential</span> : userRole === 'VENDOR' ? 'MAERSK LINE' : '3SC CONTROL TOWER'}
